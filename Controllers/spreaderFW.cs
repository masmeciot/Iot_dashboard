...
namespace Iot_dashboard.Controllers
{
    ...
    /// </summary>
    public class spdUpdateController : Controller
    {
        ...
        public spdUpdateController(IWebHostEnvironment environment)
        {
        ...
        {
            return View("~/Views/fileUploadSPD.cshtml");
        }
        ...
        [HttpPost("fwSpreader/UploadFile")]
        public async Task<IActionResult> UploadFile()
        {
            ...
            var folderPath = Path.Combine(_environment.WebRootPath, "fwSpreader");
            ...
            var fileUrl = $"{Request.Scheme}://{Request.Host}/fwSpreader/update.bin";
