...
namespace Iot_dashboard.Controllers.AMR
{
    ...
    public class L3Controller : Controller
    {
        ...
        public class AppDbContext8 : DbContext
        {
            public DbSet<KreedaIot_AMR> amr { get; set; }

            public AppDbContext8(DbContextOptions<AppDbContext8> options) : base(options)
            {
            }
        }
        private readonly AppDbContext8 _dbContext;

        private readonly AppDbContext19 _dbContext1;

        public class AppDbContext19 : DbContext
        {
            public DbSet<park> park { get; set; }

            public AppDbContext19(DbContextOptions<AppDbContext19> options) : base(options)
            {
            }
        }
        ...
        public L3Controller(AppDbContext8 dbContext, AppDbContext19 dbContext1)
        {
        ...
        {
            return View("~/Views/AMR/AMR_loc/L3.cshtml");
        }
        ...
        public async Task<IActionResult> GetData()
        {
            try
            {
                ...
                var Data = await _dbContext.amr
                  .Where(entry => entry.location == "L3" && entry.status != "Complete")
